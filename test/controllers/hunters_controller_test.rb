...
class HuntersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hunter" do
    assert_difference('Hunter.count') do
      post hunters_url, params: { hunter: { description: @hunter.description, email: @hunter.email, name: @hunter.name } }
    end
  ...
  test "should update hunter" do
    patch hunter_url(@hunter), params: { hunter: { description: @hunter.description, email: @hunter.email, name: @hunter.name } }
