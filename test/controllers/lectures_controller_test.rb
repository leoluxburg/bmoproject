...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { content: @lecture.content, description: @lecture.description, number: @lecture.number, title: @lecture.title } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { content: @lecture.content, description: @lecture.description, number: @lecture.number, title: @lecture.title } }
